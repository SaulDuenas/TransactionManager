...
public class MetaData {
   ...
   public MetaData(String colname,int orderid,String colnameparent,int orderidparent,String sqltype,String format) {
	   this.colname = colname;
	   this.colnameParent= colnameparent;
   ...
   public ArrayList<MetaData> List() {
	...
	public void setColnameParent(String colnameParent) {
		this.colnameParent = colnameParent;
	}
