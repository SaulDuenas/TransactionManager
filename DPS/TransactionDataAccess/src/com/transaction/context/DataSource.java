...
public class DataSource  {
	...
	DataSource(String datasource,String name,String url,String user,String password,String driverclassname,String validationQuery){
	  ...
	  public DataSource GetDataSource(String DatasourceName) {
	      if (list == null) {
	        	for(DataSource ds:list) {
	    	  		if (ds.getDatasource().equals(DatasourceName)) {
	    	  			return ds;
	    	  		}
	    	  	}
	      }
...
/** PK - Clave de la Conexión a Base de Datos
    ...
    * 
    * @pdOid bdfc2526-786c-4467-a074-3f4af9288a63 */
   ...
   /** @pdOid 7cb1410f-bdd1-4074-afa0-32b69e528331 */
   public String getDatasource() {
      return datasource;
   }
   
   /** @param newDatasource
    * @pdOid f3add701-f719-42f9-9180-b473812c977f */
